(function() {
  ...
  RetinaImage.prototype.swap = function(path) {
    ...
    function load() {
		...
		if (that.el.complete) { 
			if (parseInt(that.el.getAttribute("width"), 10) > 0) {
				that.el.setAttribute("width", that.el.getAttribute("width"));
			} else {
				that.el.setAttribute("width", that.el.offsetWidth);
			}
			if (parseInt(that.el.getAttribute("height"), 10) > 0) {
				that.el.setAttribute("height", that.el.getAttribute("height"));
			} else {
